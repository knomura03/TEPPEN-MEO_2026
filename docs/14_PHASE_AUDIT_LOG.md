...
## 2026-02-09T05:27:36.636Z PHASE1 PASS

- command: `npm run audit:phase1`
- commit: `65f54bed711dca31eaade8b4b0db38f6996ccd9e`
- output: `output/audit/phase1/20260209_142736`
- A(static): PASS (run typecheck=OK(3.2s), run build=OK(4.4s), run smoke:contracts=OK(204ms))
- B(db): PASS (13 checks)
  - logs: `output/audit/phase1/20260209_142736/B_db`
- preflight(users): PASS
  - logs: `output/audit/phase1/20260209_142736/preflight_users`
- C(e2e): PASS (artifacts: `output/audit/phase1/20260209_142736/C_e2e`)

## 2026-02-09T17:26:44.547Z PHASE4 PASS

- command: `npm run audit:phase4`
- commit: `397dc9a5985158e41437e1d3500f3b44baa6e793`
- output: `output/audit/phase4/20260210_022644`
- A(static): PASS (run typecheck=OK(2.7s), run build=OK(3.5s), run smoke:contracts=OK(162ms))
- B(db): PASS (5 checks)
  - logs: `output/audit/phase4/20260210_022644/B_db`
- preflight(users): PASS
  - logs: `output/audit/phase4/20260210_022644/preflight_users`
- C(e2e): PASS (artifacts: `output/audit/phase4/20260210_022644/C_e2e`)

## 2026-02-09T17:29:53.791Z PHASE4 FAIL

- command: `npm run audit:phase4`
- commit: `5743070b037729839a649c973a3db3088c0b6935`
- output: `output/audit/phase4/20260210_022953`
- A(static): PASS (run typecheck=OK(3s), run build=OK(3.4s), run smoke:contracts=OK(165ms))
- B(db): PASS (5 checks)
  - logs: `output/audit/phase4/20260210_022953/B_db`
- preflight(users): PASS
  - logs: `output/audit/phase4/20260210_022953/preflight_users`
- C(e2e): FAIL(exit=1) (artifacts: `output/audit/phase4/20260210_022953/C_e2e`)

## 2026-02-09T17:32:59.376Z PHASE4 FAIL

- command: `npm run audit:phase4`
- commit: `4a590abaaf8a559e77089045b6e2f61f2ebb47d4`
- output: `output/audit/phase4/20260210_023259`
- A(static): PASS (run typecheck=OK(2.8s), run build=OK(3.4s), run smoke:contracts=OK(160ms))
- B(db): PASS (5 checks)
  - logs: `output/audit/phase4/20260210_023259/B_db`
- preflight(users): PASS
  - logs: `output/audit/phase4/20260210_023259/preflight_users`
- C(e2e): FAIL(exit=1) (artifacts: `output/audit/phase4/20260210_023259/C_e2e`)

## 2026-02-09T17:34:44.117Z PHASE4 FAIL

- command: `npm run audit:phase4`
- commit: `136a91a7ef32c162f8cd06b3aef99b4cd64c2cfc`
- output: `output/audit/phase4/20260210_023444`
- A(static): PASS (run typecheck=OK(2.8s), run build=OK(3.6s), run smoke:contracts=OK(188ms))
- B(db): PASS (5 checks)
  - logs: `output/audit/phase4/20260210_023444/B_db`
- preflight(users): PASS
...
## 2026-02-09T17:41:26.504Z PHASE4 PASS

- command: `npm run audit:phase4`
- commit: `a7cd56d92e787bbdad7d4de83c55b178b16a2137`
- output: `output/audit/phase4/20260210_024126`
- A(static): PASS (run typecheck=OK(2.7s), run build=OK(3.4s), run smoke:contracts=OK(170ms))
- B(db): PASS (5 checks)
  - logs: `output/audit/phase4/20260210_024126/B_db`
- preflight(users): PASS
  - logs: `output/audit/phase4/20260210_024126/preflight_users`
- C(e2e): PASS (artifacts: `output/audit/phase4/20260210_024126/C_e2e`)

## 2026-02-10T01:32:15.016Z PHASE1 PASS

- command: `npm run audit:phase1`
- commit: `da132f5f9bd13c17e3916b6d8374d00ef1fd761c`
- output: `output/audit/phase1/20260210_103215`
- A(static): PASS (run typecheck=OK(2.8s), run build=OK(3.4s), run smoke:contracts=OK(157ms))
- B(db): PASS (13 checks)
  - logs: `output/audit/phase1/20260210_103215/B_db`
- preflight(users): PASS
  - logs: `output/audit/phase1/20260210_103215/preflight_users`
- C(e2e): PASS (artifacts: `output/audit/phase1/20260210_103215/C_e2e`)

## 2026-02-10T01:33:17.910Z PHASE2 PASS

- command: `npm run audit:phase2`
- commit: `2eadcf49298a81ad039f3e267702531253ca1d56`
- output: `output/audit/phase2/20260210_103317`
- A(static): PASS (run typecheck=OK(2.7s), run build=OK(3.5s), run smoke:contracts=OK(164ms))
- B(db): PASS (15 checks)
  - logs: `output/audit/phase2/20260210_103317/B_db`
- preflight(users): PASS
...
## 2026-02-10T01:51:34.152Z PHASE4 PASS

- command: `npm run audit:phase4`
- commit: `9d967c8e2e46cd616e7faacc4557f49909a5f36e`
- output: `output/audit/phase4/20260210_105134`
- A(static): PASS (run typecheck=OK(2.9s), run build=OK(3.2s), run smoke:contracts=OK(158ms))
- B(db): PASS (5 checks)
  - logs: `output/audit/phase4/20260210_105134/B_db`
- preflight(users): PASS
